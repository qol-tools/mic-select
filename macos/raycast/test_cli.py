"""Unit tests for Raycast CLI interface."""
import json
import sys
...
class TestListCommand:
    ...
    def test_list_command_success(self, mock_exit, mock_stdout):
        ...
        from macos.raycast.raycast_cli import list_command
...
class TestSwitchCommand:
    ...
    def test_switch_command_success(self, mock_exit, mock_stdout):
        ...
        from macos.raycast.raycast_cli import switch_command
...
class TestOutputJson:
    ...
    def test_output_json_success(self, mock_exit, mock_stdout):
        ...
        from macos.raycast.raycast_cli import output_json
    ...
    def test_output_json_error(self, mock_exit, mock_stdout):
        ...
        from macos.raycast.raycast_cli import output_error
